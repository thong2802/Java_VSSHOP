                ...
                <div className='order-list-container'>                    
                    {
                        this.props.orderList.map(item =>
                            <div>
                                    ...
                                    <div>
                                        {
                                            ...
                                            <div style={{margin: '0 160px'}}>
                                                {
                                                    item.order.payment === 'PayPal' ?
                                                    <PayPal product={ item.product } order={ item.order } />:
                                                    null
                                                }
                                            </div>                                            
                                        }                                        
                                ...
                                <hr style={{ margin: '100px 0' }} className='horizontal-line' />                                
                            </div>
                        )
                    }                    
                </div>
...
export default connect(mapStateToProps)(withRouter(AccountOrderList));